...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.0.0-beta+20230601044120.xcframework.zip",
			checksum: "57c0ecd4e5f04b804f1554d05889ed17566683329afa2eeccb06c213833cdbf4"
		)
	]
)