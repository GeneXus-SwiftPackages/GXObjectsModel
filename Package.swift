...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-2.2.0-beta.19.xcframework.zip",
			checksum: "53c7af01c4a0682dda7d9ed0acdb04342b7a7eb40671e8ab9da47bde6ad30d43"
		)
	]
)