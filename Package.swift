...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.3.0-beta.2.xcframework.zip",
			checksum: "90711a4224e1e9b4f6037df7f0df2d2bad413ac1475793745d5aa0d3d7b3b874"
		)
	]
)