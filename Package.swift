...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-4.2.0-beta.14.xcframework.zip",
			checksum: "2f4962b48d0113eef6a48a3a6a28bbc947aef7db43a802d313fedd0ee1d0bb78"
		)
	]
)