...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-3.0.0-rc.8.xcframework.zip",
			checksum: "1134bc1827600a24383b05e57162669dc9f5b74c9fcb1de98fd34f621487c8e2"
		)
	]
)