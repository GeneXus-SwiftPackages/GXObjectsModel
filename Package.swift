...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/releases/GXObjectsModel-4.0.17.xcframework.zip",
			checksum: "746a9884c10007c0a6541c826cf9fda9ac0d74f6fb5a3802c4f9b105f7900a97"
		)
	]
)