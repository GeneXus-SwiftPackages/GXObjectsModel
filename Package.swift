...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-4.1.0-beta.22.xcframework.zip",
			checksum: "4767761fe74912881a695614b86fd880faa9fd1a293f54a370264dce51fac5b2"
		)
	]
)