...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.2.0-beta.24.xcframework.zip",
			checksum: "fcf0f03a878914da3311394bafba1e6db1b03c5222942f29c0aa8fb0894198b0"
		)
	]
)