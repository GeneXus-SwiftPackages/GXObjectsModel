...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.1.0-beta.9.xcframework.zip",
			checksum: "15ead8850ad9b9f81466fb0eab58b9942e3d7e0e4f964895bd5824de027d2767"
		)
	]
)