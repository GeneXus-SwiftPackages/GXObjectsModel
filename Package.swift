...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-2.1.0-beta.26.xcframework.zip",
			checksum: "40c9bc665bb468ec0c88338682e0c2cf41b4293c86832cba44c5450c0cd75f51"
		)
	]
)