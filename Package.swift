...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-1.2.0-rc.1.xcframework.zip",
			checksum: "2c442c367edd3b29b043a24f829c9224bcbdb7e825c6fbb1f863dab9e9c3da7f"
		)
	]
)