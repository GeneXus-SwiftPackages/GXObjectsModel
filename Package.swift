...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.0.0-beta+20230420132651.xcframework.zip",
			checksum: "4264c556ee1108a265121c84cdc7da47f341a30429e2b15617a7411e3bd9f2ff"
		)
	]
)