...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-4.2.0-beta.11.xcframework.zip",
			checksum: "3ba4990633d63463dceffee3483817babc6ee66229b7dcd1acfe3d326dd74773"
		)
	]
)