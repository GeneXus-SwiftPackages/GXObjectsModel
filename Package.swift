...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-2.0.0-rc.36.xcframework.zip",
			checksum: "804663f43ad21b7da04f243bc91fe5454453f9070835ea82ba8ab64442f467d6"
		)
	]
)