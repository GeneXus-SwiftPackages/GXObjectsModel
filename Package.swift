...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.0.0-beta+20230504180356.xcframework.zip",
			checksum: "4947e90e58512452e0d97b24d6aa1483323e399db10675c1df07d34fc4465f38"
		)
	]
)