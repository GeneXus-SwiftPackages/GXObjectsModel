...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-1.4.0-rc.5.xcframework.zip",
			checksum: "038ea21f3e4b5c5403180b25399058d79b45c1167d359c915de7f62402ea906c"
		)
	]
)