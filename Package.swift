...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.4.0-beta.5.xcframework.zip",
			checksum: "d112191155f89069d6a6ee46c8369c165de69a524cef49f7193e27af2fbc3247"
		)
	]
)