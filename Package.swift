...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.3.0-beta.7.xcframework.zip",
			checksum: "5b5ec78464865e1c66a8efcee48eb67211a264d8f779179f4e3ebdc419c1f35b"
		)
	]
)