...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.2.0-beta.37.xcframework.zip",
			checksum: "245b39459fbcade0e6043d183cf378e934edc7b74624a100b29abf0c878971d7"
		)
	]
)