...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-2.0.0-beta.6.xcframework.zip",
			checksum: "413e54c69b20d9ff4edc3eabc48603881ac0dd9f4b6dce4f27fd4be85131d207"
		)
	]
)