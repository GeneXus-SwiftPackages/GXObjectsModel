...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.5.0-beta.18.xcframework.zip",
			checksum: "f90046b4916639f8097462c912fb02ed753d85f7f6e82d1d2e7f1bc1cb2fcf54"
		)
	]
)