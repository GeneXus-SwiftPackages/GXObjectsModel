...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-5.0.0-beta.1.xcframework.zip",
			checksum: "474455ec69a4ce8da4de9db8b830787caebd988d469379e671bfab65dd8a4ecf"
		)
	]
)