...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.3.0-beta.8.xcframework.zip",
			checksum: "4054c657465c8f9e3d55c092e5fd5973b323eba38b177053bb15c129b624cb0e"
		)
	]
)