...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.0.0-beta.17.xcframework.zip",
			checksum: "a84fb37f0cfec6418273bde4506c8b43d197d68f5c34083ca64280f53de35df0"
		)
	]
)