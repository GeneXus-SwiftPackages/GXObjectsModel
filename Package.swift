...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.4.0-beta.14.xcframework.zip",
			checksum: "1c2564f64e541d3dfeef98881ca2d16ca1edeb871affbb920f41c4a692a677b6"
		)
	]
)