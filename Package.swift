...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.5.0-beta.8.xcframework.zip",
			checksum: "805256828d0c7e703f59dc11d032f2013aee92843e1812c335cf8eb7c27490b2"
		)
	]
)