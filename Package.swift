...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-4.1.0-rc.24.xcframework.zip",
			checksum: "6d4911ac49810d2675c0113831ce9d0482b86ba9cf8a210226186d7935bcb320"
		)
	]
)