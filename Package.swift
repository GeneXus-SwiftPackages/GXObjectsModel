...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.2.0-beta.40.xcframework.zip",
			checksum: "b6ebf1e5e4d007f52109bb12d117fc078d0588f78fee8ac5ec501591fe0394ce"
		)
	]
)