...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.1.0-beta.12.xcframework.zip",
			checksum: "1e5adfd7aedf0f423f01690470c4be8a128511c435009945b4249200ac3f07d5"
		)
	]
)