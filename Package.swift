...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.5.0-beta.11.xcframework.zip",
			checksum: "f8c1c859414aee328184cf94acda7ac960121ec5aea0b6418e162b506ed47b6d"
		)
	]
)