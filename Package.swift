...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-2.0.0-beta.18.xcframework.zip",
			checksum: "fff6ddfc984981b78ab6db3433df40123a8733682942cae0c4c3ecf9c5ef10fc"
		)
	]
)