...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.5.0-beta.9.xcframework.zip",
			checksum: "b4ab0096e1a55bd0bc1c58fcfb8a9f3b5a6e512c8f9d41b56b2fb0a15a4e5750"
		)
	]
)