...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/releases/GXObjectsModel-1.4.29.xcframework.zip",
			checksum: "a973bf6b3f1d9e10d655614d515810a6b3e0c58085d461691c103116ed2ad3c9"
		)
	]
)