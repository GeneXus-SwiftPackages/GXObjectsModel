...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.5.0-beta.24.xcframework.zip",
			checksum: "0eaa84b1e1b4aedd43396cc19cc135e2d8ba70fb96263538ee9898dcdbb10da0"
		)
	]
)