...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.2.0-beta.30.xcframework.zip",
			checksum: "f6c26319aaac6e3f4504845b8ca5915c0122cc33d0a509799961de17e4593ddb"
		)
	]
)