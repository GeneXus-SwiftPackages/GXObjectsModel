...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.1.0-beta.6.xcframework.zip",
			checksum: "0e54edecfebe42238681a41bde16566da6e8a1a0c4ab044222b03356bcab139b"
		)
	]
)