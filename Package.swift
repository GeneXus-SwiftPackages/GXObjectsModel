...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-5.0.0-beta.4.xcframework.zip",
			checksum: "01b65d1a530486a705affdf4e30e87cf30a2181b1d08f7fccc79f663f83c98f5"
		)
	]
)