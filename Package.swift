...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.2.0-beta.17.xcframework.zip",
			checksum: "09fc4c5d85e05064aaba9eb633a36e36b94ddee26559c7d6a6918fd5103d9333"
		)
	]
)