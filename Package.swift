...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-2.1.0-beta.23.xcframework.zip",
			checksum: "51c8894244e34159be92978725a369e81dcb5faae05997134f95dcdaa3016f44"
		)
	]
)