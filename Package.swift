...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-4.2.0-rc.37.xcframework.zip",
			checksum: "cc6f1a56ffe40cb78fb75771c4c6b8c12d0e4c243b8e6484496f44115b3eb55d"
		)
	]
)