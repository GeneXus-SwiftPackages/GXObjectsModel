...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-2.2.0-beta.24.xcframework.zip",
			checksum: "3c4ed26ff213fa67773206d167bcfb75a31ed6abc79e71f86585af8768f65e87"
		)
	]
)