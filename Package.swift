...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.2.0-beta.20.xcframework.zip",
			checksum: "a510836097c7cfef77ff6a4bb46c666a8fa899e732318d89d4505f0e6d75d413"
		)
	]
)