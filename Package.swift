...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-4.0.0-beta.47.xcframework.zip",
			checksum: "ed1890fa59f891fbc70966a7150c03d2159602cc472c353e9685fffcf2b13a91"
		)
	]
)