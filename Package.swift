...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.1.0-beta.0.xcframework.zip",
			checksum: "5c5bc104ffc226ffc97b43bddb01839571aaf302a9b56a3e2ef03404d5268bfc"
		)
	]
)