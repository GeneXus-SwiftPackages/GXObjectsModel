...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-3.2.0-rc.11.xcframework.zip",
			checksum: "1e732a31c3874c64cfa35efdf7f0a9d05e5da5d66b9b3722c438126809bae833"
		)
	]
)