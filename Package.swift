...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.3.0-beta.9.xcframework.zip",
			checksum: "0219444481dd6d7c699587da77084ccbdd8f24d93c7c24bd501c03b6efa7798f"
		)
	]
)