...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.0.0-beta.10.xcframework.zip",
			checksum: "4f7b7e3aea37cf09e7516fa830d3a4af79efc2cdcb8f4aad5c7ff1507a5920a1"
		)
	]
)