...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.2.0-beta.36.xcframework.zip",
			checksum: "199b8d5edcf01196aa32ff3dbbb2181d54828d4f3c1c00d6650230e63269af16"
		)
	]
)