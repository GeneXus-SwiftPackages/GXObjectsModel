...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.5.0-beta.17.xcframework.zip",
			checksum: "589148a1cc7eb7524bbb94646dd8f1d0abe4d3aef1a1a10219b1d6639c4244e4"
		)
	]
)