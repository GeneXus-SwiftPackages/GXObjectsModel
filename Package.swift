...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-1.1.0-rc.4.xcframework.zip",
			checksum: "e01799cde85bfed049cacfc50338cba33a17eb10d7dfcbd54ba197241a271600"
		)
	]
)