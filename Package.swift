...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.5.0-beta.13.xcframework.zip",
			checksum: "3be15c677f32bb7b9ae1965bf2cf1bf666c5e4146228ceb386e0e10a83aea53f"
		)
	]
)