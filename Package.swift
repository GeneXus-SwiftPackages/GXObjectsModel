...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-2.2.0-beta.10.xcframework.zip",
			checksum: "e2a0e95a0e0744fa1a53af566d86cdb4c79964cb5cac973bdd05dd52ff5b2196"
		)
	]
)