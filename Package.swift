...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.5.0-beta.10.xcframework.zip",
			checksum: "9d75d808c35cca84f948aa574144d57eadc38a5efee4ec7e803309d4d6ff5c69"
		)
	]
)