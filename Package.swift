...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.5.0-beta.25.xcframework.zip",
			checksum: "c7c825dd8031d8834529e8d1afa54af2337a8b2e5b875923ed209b9456002d0a"
		)
	]
)