...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.2.0-beta.38.xcframework.zip",
			checksum: "dc2618f5141edc77e9cb5cd6280ca5b3a6ca92a035b12318f99a24a0d0c6fb77"
		)
	]
)