...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/releases/GXObjectsModel-4.0.16.xcframework.zip",
			checksum: "d702e404a560a170cd9d9678d6e3fbee9d72fbb97a2fa1a4f079fefeac5441e4"
		)
	]
)