...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.0.0-beta.20230714111921.xcframework.zip",
			checksum: "bb94839916ebb3c76a7335b2eaebbf9421a3a86e419d0e09703451e895a113f5"
		)
	]
)