...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-2.0.0-beta.26.xcframework.zip",
			checksum: "2136adaa251ba8dd5a14694e7b0e2b5146e6359a0be2fa4e238ec1976403b71c"
		)
	]
)