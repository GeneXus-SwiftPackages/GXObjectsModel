...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-2.0.0-beta.23.xcframework.zip",
			checksum: "ee0a716b7c1c37812f97109f0507a77a599bee81692b0a703ede625b4c6b4315"
		)
	]
)