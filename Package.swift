...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.4.0-beta.2.xcframework.zip",
			checksum: "ae8bf6c662115758c396df87b52298a3255a73a32de957e3adcfbae8ba2dbf79"
		)
	]
)