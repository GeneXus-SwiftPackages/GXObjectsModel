...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-2.1.0-beta.25.xcframework.zip",
			checksum: "bbe97d01b9f446f707faefe5e5d077ac81a5c56f80965d7c7a03a9a7b58bd319"
		)
	]
)