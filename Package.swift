...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.0.0-beta+20230302113401.xcframework.zip",
			checksum: "35e1f45b64f0e6f0de121b9c67cc90a8e6fb9a5f03d141eefe60518e280725be"
		)
	]
)