...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.5.0-beta.12.xcframework.zip",
			checksum: "ecc0190ddbf80ff8e73138a550a2a10a6401146ed87d03d9d9be196f8536c25c"
		)
	]
)