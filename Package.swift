...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.1.0-beta.27.xcframework.zip",
			checksum: "8a10882b051c44e622051999d91ff1c0f721acf4b839f34d4bc625a6e87dc622"
		)
	]
)