...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.1.0-beta.11.xcframework.zip",
			checksum: "996b1d9171405f340929175f380de87c33573652fe2e30df45a4e08c36f831ee"
		)
	]
)