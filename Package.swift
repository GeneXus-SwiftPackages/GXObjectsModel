...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.2.0-beta.21.xcframework.zip",
			checksum: "dc3e907e65c2695ac3bb5cda764472e9639e4adc4d93faa7238200f45be30d23"
		)
	]
)