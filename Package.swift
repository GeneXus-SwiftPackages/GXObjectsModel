...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.0.0-beta+20230515174624.xcframework.zip",
			checksum: "817008fed710dcf7f4cc1c5f26d0e6daf09deb0f627541004733993e5750d184"
		)
	]
)