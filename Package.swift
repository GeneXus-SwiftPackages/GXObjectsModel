...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.2.0-beta.34.xcframework.zip",
			checksum: "5dcab8425bff7c6d562073a7f2b1fa1613e601608f1ced72d3f99df13b04d059"
		)
	]
)