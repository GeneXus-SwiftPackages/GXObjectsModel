...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.2.0-beta.41.xcframework.zip",
			checksum: "2a1179f3db1a77bd112a08a5d1e0ab4684028374a55aefb94550ffce14c33e1e"
		)
	]
)