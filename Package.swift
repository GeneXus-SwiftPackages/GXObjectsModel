...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/releases/GXObjectsModel-2.0.17.xcframework.zip",
			checksum: "96afb9c29eb84e2ec05928f87aa46cf1039b287a633134bf5d465d738766fd6e"
		)
	]
)