...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-3.2.0-rc.12.xcframework.zip",
			checksum: "3264f4f2e71aed4188741688d513f77624269c44eb12e3f557c3ffa892062616"
		)
	]
)