...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.1.0-beta.10.xcframework.zip",
			checksum: "345abc4f2b3aa10d875aa48792565ca8bfddd00f70d537e5d73d9d9c884e3f23"
		)
	]
)