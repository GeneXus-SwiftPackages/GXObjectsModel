...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-2.0.0-beta.37.xcframework.zip",
			checksum: "671eecd2fe8197cd165bb7ecae0e5173249db94991b434d0bcbca7af9d705e45"
		)
	]
)