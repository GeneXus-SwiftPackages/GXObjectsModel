...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.1.0-beta.32.xcframework.zip",
			checksum: "ee97a3898d958c9dc88409fe6dcdf54af246d8aef3a426453b26f8f8f278c5d6"
		)
	]
)