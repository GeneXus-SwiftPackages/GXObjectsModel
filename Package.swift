...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.3.0-beta.10.xcframework.zip",
			checksum: "fa7a00e315b5bc4e49636f5d999186ba9367277b403cbdd832d68bfca55fee87"
		)
	]
)