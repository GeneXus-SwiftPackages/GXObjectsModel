...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-4.1.0-beta.23.xcframework.zip",
			checksum: "9e0e515d46f078094f80ae93d79cfb060a32cdde18d6fc4a8606d7ebad7f1194"
		)
	]
)