...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.2.0-beta.10.xcframework.zip",
			checksum: "4d72d46ae1ef12e26d9fe9c6bf8bce9cb8a31604edab7ff6f9e1bde513d92dc7"
		)
	]
)