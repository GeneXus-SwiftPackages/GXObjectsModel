...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-4.2.0-beta.22.xcframework.zip",
			checksum: "72164adb21b382e8e1680c890388cb775af396daec1e7228fa95f45a30434025"
		)
	]
)