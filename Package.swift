...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-1.1.0-rc.3.xcframework.zip",
			checksum: "6c8d33d73ee2da49d6c17e5ca98352221912580bee1ed0b0b662648e67816c6a"
		)
	]
)