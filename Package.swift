...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.0.0-beta+20230315133647.xcframework.zip",
			checksum: "ac5d50af011435c9345f864cffa9c3907a47ff68f69aae8f3f308ba4f22a9c3e"
		)
	]
)