...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-2.0.0-rc.22.xcframework.zip",
			checksum: "aa8c4c9586792a3c6cad545ccfcc7f324c1a2f942e61ecdbeedc4cfcfa6f35c4"
		)
	]
)