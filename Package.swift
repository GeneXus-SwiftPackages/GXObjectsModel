...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/releases/GXObjectsModel-2.0.18.xcframework.zip",
			checksum: "09806e35e6eee99b84a4b2946243b9c53de60ffd3087da7ec23fae4fdeecc9c8"
		)
	]
)