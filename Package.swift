...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/releases/GXObjectsModel-1.4.31.xcframework.zip",
			checksum: "1a4ac36e6a79983365cf19f22f6d6223fa905cbcd41251088be50954f785805f"
		)
	]
)