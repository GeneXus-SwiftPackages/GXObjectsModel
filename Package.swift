...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.1.0-beta.795.xcframework.zip",
			checksum: "62a507fecc696f6d9aa9f73d4e93cd0aa17313c6cfb5c23dc7510a4069e16235"
		)
	]
)