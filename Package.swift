...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/releases/GXObjectsModel-1.1.0-rc.1.xcframework.zip",
			checksum: "73aa25daa38f96dc0d2fbd613077af74b42d4cd2c3a30ac5abae489d92837d39"
		)
	]
)