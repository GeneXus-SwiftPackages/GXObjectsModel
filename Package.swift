...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.2.0-beta.25.xcframework.zip",
			checksum: "7853f6e25de1b6f865681e969472cb985eb47d4db61c02abac52ba60114b1b08"
		)
	]
)