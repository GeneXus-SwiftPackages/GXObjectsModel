...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.1.0-beta.9.xcframework.zip",
			checksum: "3648f711d7cc6a1607197454850df2da4226cdeff2a0076fafc408f7af7eac6c"
		)
	]
)