...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.5.0-beta.15.xcframework.zip",
			checksum: "b003ddd24dfefe48287f831421c24f44d8c635c6d363d38481049742ccdebb45"
		)
	]
)