...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-5.0.0-beta.5.xcframework.zip",
			checksum: "43fb62d9d121e50c64c71c4d3109daa4bc32a4bb2d170c5776464b0300108583"
		)
	]
)