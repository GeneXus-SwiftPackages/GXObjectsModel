...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.2.0-beta.21.xcframework.zip",
			checksum: "f388ebfd869d7b0ba3b02ac98b20230fa8eac57b87d4b39a099185d626adaf1f"
		)
	]
)