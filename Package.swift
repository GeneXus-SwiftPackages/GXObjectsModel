...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.0.0-beta+20230315120127.xcframework.zip",
			checksum: "2391daf8a2b1b04e158940b5ed2625ad656c3720cd8e8db4b486c334ac70e21f"
		)
	]
)