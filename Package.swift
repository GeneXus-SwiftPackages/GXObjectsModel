...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.0.0-beta+20230328162416.xcframework.zip",
			checksum: "84660943ab53b93ae06d1b7e892d8bb920d3c31055b37e857535cd737f520b5c"
		)
	]
)