...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.2.0-beta.14.xcframework.zip",
			checksum: "f016c7bde8261c7a7e13a8fc7a9573a68b2cc97e0045ad59aef26dc41b90a390"
		)
	]
)