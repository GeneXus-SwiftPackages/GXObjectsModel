...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-5.0.0-rc.0.xcframework.zip",
			checksum: "cc047c295aa390de29a0f2040f42d740d9d3c2933fef8707f1c514d9d856c652"
		)
	]
)