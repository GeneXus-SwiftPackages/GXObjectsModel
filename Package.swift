...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.4.0-beta.8.xcframework.zip",
			checksum: "145ae22c6ab3d6832408fd2d60c56eb34e4cfb59225a1e2e328d9d28f1893f13"
		)
	]
)