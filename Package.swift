...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-5.0.0-rc.1.xcframework.zip",
			checksum: "2f287341c5a81d6197fb8ec85a32652ac35d7c1cf40d4fe078aed6caf900a359"
		)
	]
)