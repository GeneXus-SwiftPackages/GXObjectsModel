...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-1.4.0-rc.1.xcframework.zip",
			checksum: "8a7e9eead0e86668768707fe855d611f48745a515529f93cdf28073aa3421507"
		)
	]
)