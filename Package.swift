...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.2.0-beta.36.xcframework.zip",
			checksum: "3341eb2817175cca16242c3133b7e313089941ed7f3aafa020ce0ae33263e439"
		)
	]
)