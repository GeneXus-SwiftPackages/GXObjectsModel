...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.0.0-beta.16.xcframework.zip",
			checksum: "2678f1f332513432c40bd3e2973eceb62223b3d761f03026369f27e746dc5edf"
		)
	]
)