...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.1.0-beta.4.xcframework.zip",
			checksum: "ecfffc466a621eda578dc31b54672542b2cb8e7cac2a9c0636395a05b90f6025"
		)
	]
)