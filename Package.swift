...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.0.0-beta+20230427140435.xcframework.zip",
			checksum: "68385a1f34701f3ac7065a94ca2a836cdda07dcde6db7d21d3a13cb699eede6c"
		)
	]
)