...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-1.4.0-rc.10.xcframework.zip",
			checksum: "514ac6fb3a4da84786cc4dfe9f5274661b5da5a2364893aacd60b36d8536b68d"
		)
	]
)