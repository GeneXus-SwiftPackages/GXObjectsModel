...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-4.0.0-rc.0.xcframework.zip",
			checksum: "ec5468be652d0b3b4e2f29df6a3e5caa8ee35750b4e70d799e749d67db18394b"
		)
	]
)