...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-4.1.0-beta.9.xcframework.zip",
			checksum: "bdc2f8577c736a9bf98ab3993d6bbf5ced661cccfcc03b6bf1a6c6d02fe27e0b"
		)
	]
)