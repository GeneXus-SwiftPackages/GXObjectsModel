...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.1.0-beta.17.xcframework.zip",
			checksum: "ee0c2d7bf9a40d25dc56f176133504e2fa122a3f5ddfdca66179690ca805922e"
		)
	]
)