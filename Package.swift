...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-4.1.0-rc.14.xcframework.zip",
			checksum: "3432dbc54c2552e69ef494b8fa55245b75b138fdc1ed7d952da0eb7f04eadfb6"
		)
	]
)