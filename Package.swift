...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.5.0-beta.4.xcframework.zip",
			checksum: "28889091c4a4102429c875527f17a47aaa87cd5432e04def1ed39d9dd7d8fa70"
		)
	]
)