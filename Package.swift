...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.5.0-beta.19.xcframework.zip",
			checksum: "fc7214ce81fccfdd0d2d47484cee48e7770de6ec26d5405bff666a97004028b3"
		)
	]
)