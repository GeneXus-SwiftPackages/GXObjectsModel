...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-4.2.0-beta.15.xcframework.zip",
			checksum: "3b86155aea054daa62d41939701cf398143b154bbc8f9950f6a3c4e55cf8f8cb"
		)
	]
)