...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-1.2.0-rc.25.xcframework.zip",
			checksum: "e6dc6364ec665a98c0d18751f26f8895ce64dc9ef6ce0b84a88ce70ece787a55"
		)
	]
)