...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/releases/GXObjectsModel-1.4.30.xcframework.zip",
			checksum: "4aad40053d6c5a7a07f78e1d71dbf0159958c287ad2976d14bda660b5f17efe8"
		)
	]
)