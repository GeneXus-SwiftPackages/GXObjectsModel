...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-4.0.0-beta.49.xcframework.zip",
			checksum: "e29ed68f60cef7ff1c030cdd9211be73fc8c5cc6e61ac7a45097eea137203f3e"
		)
	]
)