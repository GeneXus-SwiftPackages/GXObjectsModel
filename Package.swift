...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.0.0-beta.13.xcframework.zip",
			checksum: "de7454435ecd0a2563b16d7e310c4308add0a107990de64e4b6429e5d78738de"
		)
	]
)