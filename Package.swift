...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.2.0-beta.32.xcframework.zip",
			checksum: "850c03f071888005d6812152dd90561168266e4fa06d8cba45663cb560b3de79"
		)
	]
)