...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.0.0-beta+20230309171424.xcframework.zip",
			checksum: "e38811e2074997f0daa06db60acbb77322426d68b4d014bbc76d8119a51e7e5b"
		)
	]
)