...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.2.0-beta.19.xcframework.zip",
			checksum: "15c11cddf6fa277bc785d985973e7896dd491387b10531cc042c59dbd228f99b"
		)
	]
)