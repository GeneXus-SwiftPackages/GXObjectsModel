...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.3.0-beta.1.xcframework.zip",
			checksum: "b7f925efbcc7801f7ccc9852aa80636d5a49cad456589883743f275b30b2cd20"
		)
	]
)