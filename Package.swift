...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.2.0-beta.22.xcframework.zip",
			checksum: "5c00153e48f8ab5b2da3c41266b8713ad87a1b9be31dbfcf7ec9971c07f6788b"
		)
	]
)