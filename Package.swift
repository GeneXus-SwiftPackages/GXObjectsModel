...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-1.5.0-rc.28.xcframework.zip",
			checksum: "5db608584b265957478cb844303ebe5b4a0da777de04205f7a93b40841f8084c"
		)
	]
)