...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.5.0-beta.7.xcframework.zip",
			checksum: "42d4bd2977555b6082be2705b79cae0b4fd220c060f35adec14bc4e636ca20c0"
		)
	]
)