...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.2.0-beta.23.xcframework.zip",
			checksum: "5cd5c86a4dea84ce77afbd0c36199e26c1776fc86a712ef5521e54a008d9604f"
		)
	]
)