...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-3.0.0-rc.15.xcframework.zip",
			checksum: "fc90e845ca05451ae3a847c17202ac794de77d8aec8079dc1d414d78086adde6"
		)
	]
)