...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-2.0.0-beta.31.xcframework.zip",
			checksum: "f3e48606195ef160f0154160d81e91503fb9ccd92398ca690cc2e02b1e741264"
		)
	]
)