...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.3.0-beta.11.xcframework.zip",
			checksum: "0402696ab5817d5395a20f70b02bbcfd80dae93164ca9f59395d47eec3077698"
		)
	]
)