...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-4.1.0-beta.15.xcframework.zip",
			checksum: "6ac6aeafd0db2a9d3439f1f29b707b0c447ebf61eb4e0b7547b26ba4debfecf9"
		)
	]
)