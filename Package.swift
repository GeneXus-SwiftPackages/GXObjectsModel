...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-2.0.0-beta.38.xcframework.zip",
			checksum: "b0f14e900b2072caf628cbe31bcf7a5a15e911f9f2f5482886f498bcf65ac733"
		)
	]
)