...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.6.0-beta.0.xcframework.zip",
			checksum: "6a94a6e8d8b8115aefd1f9fa5e30c9e65e2790d1eccca46cd8a65b2cc8a78382"
		)
	]
)