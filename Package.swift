...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.2.0-beta.16.xcframework.zip",
			checksum: "9d021875059b84e3c140aaffe77e98fadb7d0599d3f168fc69ab30c4ce82af00"
		)
	]
)