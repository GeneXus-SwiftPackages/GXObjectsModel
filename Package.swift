...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-4.2.0-beta.33.xcframework.zip",
			checksum: "7dc11872a6635235005611bbb41bef25d54fdd066d7d86894b85c1a4e31187ef"
		)
	]
)