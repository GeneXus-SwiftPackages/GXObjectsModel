...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-1.4.0-rc.21.xcframework.zip",
			checksum: "6c7ef6edfb9221f9d7d75f55ea32b9330877bf13ed03976abf048018fdf26c54"
		)
	]
)