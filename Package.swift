...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.3.0-beta.6.xcframework.zip",
			checksum: "645c7a2c0dfe76af5b1e645cca477bcfbf42be1c66036e18258df8abb7f61d2b"
		)
	]
)