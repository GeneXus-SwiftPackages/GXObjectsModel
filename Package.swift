...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.0.0-beta.20230614190626.xcframework.zip",
			checksum: "ab880dfc14aa9a179d607a2591717d838e525f0dbe370a7efd6442b89c723940"
		)
	]
)