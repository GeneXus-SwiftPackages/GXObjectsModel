...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.5.0-beta.20.xcframework.zip",
			checksum: "9435b512a022cdfc252f882730d273d87541c2225610fc6aa5c1678c43f18b02"
		)
	]
)