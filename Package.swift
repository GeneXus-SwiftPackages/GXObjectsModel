...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.4.0-beta.18.xcframework.zip",
			checksum: "00adf065299e5c8f7b045f6cab906cfa097c39bb6887efa0c533f6223425649b"
		)
	]
)