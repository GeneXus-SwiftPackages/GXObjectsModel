...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-4.1.0-beta.6.xcframework.zip",
			checksum: "1975ab3f3ced752d11192208523044eef7a0a5a0b912128722cbbf6d94caa315"
		)
	]
)