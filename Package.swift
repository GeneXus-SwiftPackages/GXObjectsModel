...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-4.0.0-beta.44.xcframework.zip",
			checksum: "71c74b2d2c3b4e213c015975d0feffb3f050b1dd40a3381db700b87510fbf152"
		)
	]
)