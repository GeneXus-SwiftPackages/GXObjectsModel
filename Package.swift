...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.5.0-beta.2.xcframework.zip",
			checksum: "a712021a0fb436a06127ec39402fee7eb19ecc0a753ad4b9507c8c94e806eaac"
		)
	]
)