...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.3.0-beta.5.xcframework.zip",
			checksum: "d6475912466666b7428e75d719fe8ed462062a22240a4d6dc2c3398b8263ed5a"
		)
	]
)