...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.6.0-beta.1.xcframework.zip",
			checksum: "2f0f08e9920e613c7a2b034c04c2e139ac4fdd2658f2a231d601562f92fd8a69"
		)
	]
)