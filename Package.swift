...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-2.0.0-beta.16.xcframework.zip",
			checksum: "6662dc63ef599faa316c0b6f7398705fa957607d5be8b7ca046a610b393701ad"
		)
	]
)