...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-2.0.0-beta.36.xcframework.zip",
			checksum: "d0319681e34298021857d2b4fe360d0802333f27c8a07a975d616c8e89cf6598"
		)
	]
)