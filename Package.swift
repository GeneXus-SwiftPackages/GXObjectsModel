...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.5.0-beta.26.xcframework.zip",
			checksum: "1ab7f6a0621fcf6b45791791031eea69ff6cd58b55792e1285e35c2d9394b518"
		)
	]
)