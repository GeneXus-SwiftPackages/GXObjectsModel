...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.0.0-beta+20230505145632.xcframework.zip",
			checksum: "4d6aa7bf0b96e0e42615e83f25dabf9f01c41156225b3a9392fdac802186d7cc"
		)
	]
)