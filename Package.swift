...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.1.0-beta.5.xcframework.zip",
			checksum: "d5884e5f70aee35f346422271c029b7a0ae8583a765ce7e3e73a1175f89cb3e1"
		)
	]
)