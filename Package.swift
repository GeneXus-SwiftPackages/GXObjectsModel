...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.2.0-beta.14.xcframework.zip",
			checksum: "9ae2876a33785b23fc685e89ba8dd59c40e2b25639b34f3747059f800c5759df"
		)
	]
)