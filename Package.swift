...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.2.0-beta.1.xcframework.zip",
			checksum: "b67c35452065c705336ae799f9370eb1fe12dc24ed58bc2dc08d842bb00efadd"
		)
	]
)