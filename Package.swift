...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-4.0.0-beta.48.xcframework.zip",
			checksum: "e09a84cd9f2c960e239858a8d600bc9d3c234ac45a9034083d8820f61b6a2e03"
		)
	]
)