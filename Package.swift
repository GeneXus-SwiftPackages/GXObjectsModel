...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.1.0-beta.8.xcframework.zip",
			checksum: "190f40e321ea67706e4d699f8539c95023be6e9694b4f8710679e30da3c5cfee"
		)
	]
)