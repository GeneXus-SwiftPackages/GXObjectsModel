...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.2.0-beta.26.xcframework.zip",
			checksum: "04a12d5d210d1a780a9a11d9fd34fc4cb0f1c985ea861026d962427cf4d22d1f"
		)
	]
)