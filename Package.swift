...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.4.0-beta.11.xcframework.zip",
			checksum: "484b4d2477f4637025cad4cc55ca6c14e8ed72ca03fdfe71b2e80258f12f8bbb"
		)
	]
)