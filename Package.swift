...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/releases/GXObjectsModel-1.5.11.xcframework.zip",
			checksum: "1fd0ebebabfd78fcc0c0db46c8dc4641370725fe487aa7a51f10623a6234f42d"
		)
	]
)