...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.2.0-beta.11.xcframework.zip",
			checksum: "b772cb0e23ca198b7bfc2fbee5a4a2c82dca5994a812e05feb6910b03d972d1e"
		)
	]
)