...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-4.2.0-beta.1.xcframework.zip",
			checksum: "73ca2764a7a268b67e8631867ced644cf8a9b32fa5f5d5340bd5cb7397332647"
		)
	]
)