...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.4.0-beta.13.xcframework.zip",
			checksum: "ac99b30de759a974d7d3a204cc503ff21b46df3b620561419a7c73b111d70472"
		)
	]
)