...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.1.0-beta.7.xcframework.zip",
			checksum: "afe5a49d55e9ceeefe13069e5b3b417a70688393b7e2cd84dfe8ec5547f8576d"
		)
	]
)