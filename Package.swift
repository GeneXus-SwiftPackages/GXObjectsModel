...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-3.0.0-beta.8.xcframework.zip",
			checksum: "646b11ea26011e401694eabf0386fb3cc40e0e6407921bbe9788ba50c82b2a38"
		)
	]
)