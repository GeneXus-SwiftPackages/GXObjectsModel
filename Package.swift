...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.0.0-beta+20230309142042.xcframework.zip",
			checksum: "b63366792fe09a047d041371b70ad698d8ca4771c8ee43a824e95ddfb966d334"
		)
	]
)