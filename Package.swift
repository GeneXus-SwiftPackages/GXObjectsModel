...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-1.2.0-rc.36.xcframework.zip",
			checksum: "b61be59a829213781690f8a76f369984bc8dac6ff1544868f0f5448433e79270"
		)
	]
)