...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-2.0.0-beta.20.xcframework.zip",
			checksum: "2a3b800f16d0f914a26220e6b209382a1cd7d311a8c5d823623f09040a7e7d19"
		)
	]
)