...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/preview/GXObjectsModel-3.1.0-rc.3.xcframework.zip",
			checksum: "d59484ac5f4e803ab7d1a5f14cdee79d71d7ce51677eb17f55b03db7aaeb6544"
		)
	]
)