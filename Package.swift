...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.4.0-beta.16.xcframework.zip",
			checksum: "2693125fbe2d9ff06a7008ecf8b5bda42aade3a26afc79237cb65dfe98845d9f"
		)
	]
)