...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.2.0-beta.7.xcframework.zip",
			checksum: "edb846d8871db5b2eec0d4b13668fb57eccfd18f710c337a64a63e0138995115"
		)
	]
)