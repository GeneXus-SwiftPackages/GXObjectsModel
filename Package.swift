...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.0.0-beta+20230605162159.xcframework.zip",
			checksum: "2ff5b4fc0d82846444b22344b3d8736d4297e6de5d9e02bdd59249745bcaf82b"
		)
	]
)