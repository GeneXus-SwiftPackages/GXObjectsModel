...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXObjectsModel",
			url: "https://pkgs.genexus.dev/iOS/beta/GXObjectsModel-1.0.0-beta.20230721115743.xcframework.zip",
			checksum: "1f28ca6d63b379533bdbce51852aa1cb847144c674ce09fa7edfce3dc3323cbc"
		)
	]
)